...
<?php //if (is_home()) wp_enqueue_script('journaled.js', get_template_directory_uri() . '/js/journaled.js') ?>
<?php wp_enqueue_script('journaled.js', get_template_directory_uri() . '/js/journaled.js') ?>
